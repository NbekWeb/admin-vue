...
export default [
  ...
  },
  {
    ...
    name: "default",
    meta: {
      title: "Панель управления 'Чистая вода'",
      authRequired: true,
    },
  ...
  },
  {
    path: "/tables/staff",
    name: "staff",
    meta: { title: "Тарифы на устройства", authRequired: true },
    component: () => import("../views/tables/staff"),
   },
    {
    path: "/tables/staff",
    name: "staff",
    ...
    path: "/tables/payment",
    name: "payment",
    meta: { title: "Оплата", authRequired: true },
    component: () => import("../views/tables/payment"),
  },
    {
    path: "/tables/tarif",
    name: "tarif",
    meta: { title: "Тарифы", authRequired: true },
    component: () => import("../views/tables/tarif"),
  },
  {
    path: "/tables/device",
    name: "device",
    meta: { title: "Тарифы", authRequired: true },
    component: () => import("../views/tables/device"),
  },
  {
    path: "/tables/example",
    name: "example",
    meta: { title: "Тарифы", authRequired: true },
    component: () => import("../views/tables/example"),
  },
  {
    path: "/form/advanced",
    name: "form-advanced",
  ...
  },
  {
    ...
    name: 'pay',
    meta: {
      title: "Оплата", authRequired: true,
    },
    component: () => import('../views/auth/pay/basic')
  },
  {
